Jekyll::Hooks.register(:site, :post_write) do |_site|
    ...
    system("/github/workspace/github/workspace/node_modules/.bin/purgecss --css _site/assets/css/bootstrap.min.css --content _site/**/*.html --safelist bg-light --output _site/assets/css")
  end